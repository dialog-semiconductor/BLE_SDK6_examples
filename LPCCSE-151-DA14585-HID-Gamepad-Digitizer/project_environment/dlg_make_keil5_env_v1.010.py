...
'''
###########################################################################################
# @file		:: dlg_make_keil5_env_v1.010.py
#
# @brief	:: Last modified: Apr 16th 2020.
#			   
...
#			   Example cmd:
#			   python dlg_make_keil5_env_v1.010.py -sdkpath "<user_specific_SDK6_location>"
#
#
#			   NOTE:
#			   - This script can create application environment only for SDK6.0.14.xxxx.
#			   - During the time of release the script was tested on SDK6.0.13.1103.
#			   - Supported commands:
#			   	python dlg_make_keil5_env_v1.010.py -sdkpath "<user_specific_SDK6_location>"
#			   
...
#
#              OR,
#			   python dlg_make_keil5_env_v1.010.py -sdkpath "clean" 
#
#			   After successful execution of the above command the Keil5 environment (example *.uvprojx) 
