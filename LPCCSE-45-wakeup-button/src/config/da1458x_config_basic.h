...
/****************************************************************************************************************/
/* User wakeup example. Enables the user wakeup example. If USER_WAKEUP_EXAMPLE is defined P0_6 and P1_1 are 		*/ 
/* configured as wakeup button. The user_wakeup_example.h and user_wakeup_example.c must be included in project */
/* aswell.                                                                    																	*/
/****************************************************************************************************************/
#define USER_WAKEUP_EXAMPLE
#undef SLEEP_WITHOUT_ADVERTISING
