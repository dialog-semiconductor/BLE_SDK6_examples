...
- Expose the SIG CTS profile (Current Time Service).
...
## Custom profile
A 128-bit UUID custom profile is included with 1 custom service. 
...
<tbody>
  ...
  <td style="text-align: left;">Ranges from 1 to 12</td>
  </tr>
  <tr class="even">
  <td style="text-align: left;">dd</td>
  <td style="text-align: left;">Day of the Month</td>
  <td style="text-align: left;">1</td>
  <td style="text-align: left;">Ranges from 1 to 31</td>
  </tr>
  <tr class="even">
...
The implementation code of the Custom service is included in  ``user_custs1_impl.c``. The **user_svc1_ctrl_wr_ind_handler** is implemented.
