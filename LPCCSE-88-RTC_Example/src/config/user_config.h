 ...
 ****************************************************************************************
 *
 * RTC/CTS Configuration
 *
 * - Configure the initial values of the RTC
 * - The example will apply the same values in the CTS service
 ****************************************************************************************
 */ 
 static const rtc_time_t user_time_conf = {
     .hour_mode = RTC_HOUR_MODE_24H,
     .pm_flag = 0,
     .hour = 0,
     .minute = 0,
     .sec = 0,
 ...
 static const rtc_calendar_t user_calendar_conf = {
     .year = 2021,
     .month = 6,
     .mday = 17,
     .wday = 4,
 ...
 static const rtc_config_t user_rtc_conf = {
 ...
 */
/// Device name
#define USER_DEVICE_NAME        "REAL_TIME_CLOCK"
