...
#define DEF_SVC1_RST_DETECT_UUID_128      	{0x23, 0x68, 0xEC, 0x52, 0x1E, 0x62, 0x44, 0x74, 0x9A, 0x1B, 0xD1, 0x8B, 0xAB, 0x75, 0xB6, 0x6E}



#define DEF_SVC1_CTRL_POINT_CHAR_LEN     1
#define DEF_SVC1_RST_DETECT_CHAR_LEN     20



#define DEF_SVC1_CONTROL_POINT_USER_DESC     "Control Point"
#define DEF_SVC1_RST_DETECT_USER_DESC     	 "Reset detection"
...
enum
{
    ...
    SVC1_IDX_CONTROL_POINT_USER_DESC,
		...
		SVC1_IDX_RST_DETECT_CHAR,
    SVC1_IDX_RST_DETECT_VAL,
    SVC1_IDX_RST_DETECT_USER_DESC,
